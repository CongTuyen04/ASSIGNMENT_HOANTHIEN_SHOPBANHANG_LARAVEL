...
<head>
    ...
    <title>@yield('title') | Shopthoitrang</title>
            ...
            <div class="inner-header">
                <div class="row">
                    <div class="col-lg-2 col-md-2">
                        <div class="logo">
                            <a href="/">
                                <img src="front/img/logo.png" height="40">
                            </a>
                        </div>
                    </div>
            ...
            <div class="nav-depart">
                <div class="depart-btn">
                    ...
                    <ul class="depart-hover">
                        ...
                        <li><a href="#">LOUIS Nam</a></li>
                        <li><a href="#">LOUIS Nữ</a></li> 
                    </ul>
                </div>
            </div>
            {{--  --}}
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="footer-letf">
                        <div class="footer-logo">
                            <a href="index.html">
                                <img src="front/img/footer-logo.png" height="55" alt="">
                            </a>
                        </div>
                        <ul>
                            <li>1A Trinh Van Bo . Ha Noi</li>
                            <li>Phone: +84.353.754.546</li>
                            <li>Email: tuyencon2k4@gmail.com</li>
                        </ul>
                ...
                <div class="col-lg-4">
                    <div class="newslatter-item">
                        ...
                        <p>Get Email update about our latest shop and special offers.</p>
