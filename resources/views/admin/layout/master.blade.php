                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="mm-active">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="./admin/order">
                                            <i class="metismenu-icon" class="{{ (request()->segment(2) == 'order') ? 'mm-active' : '' }}"></i>Order
                                        </a>
                                    </li>
                                    <li>
                                        <a href="./admin/product">
                                            <i class="metismenu-icon" class="{{ (request()->segment(2) == 'product') ? 'mm-active' : '' }}"></i>Product
                                        </a>
                                    </li>
                                    <li>
