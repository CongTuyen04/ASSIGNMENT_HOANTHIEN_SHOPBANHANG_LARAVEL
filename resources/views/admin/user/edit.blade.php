                        ...
                        <form action="/admin/user/{{$user->id}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    {{-- <select required name="level" id="level" class="form-control">
                                        <option value="">-- Level --</option>
                                            ...
                                            @foreach (\App\Utilities\Constant::$user_level as $key => $value )
                                                <option value={{$key}} {{ $user->level == $key ? 'seleted' : '' }}>
                                                    {{$value}}
                                                </option>
                                            @endforeach
                                    ...
                                    <select required name="level" id="level" class="form-control">
                                        <option value="">-- Level --</option>
                                        <option value="{{ \App\Utilities\Constant::user_level_admin }}">Admin</option>
                                        <option value="{{ \App\Utilities\Constant::user_level_client }}">Client</option>
                                        <option value="{{ \App\Utilities\Constant::user_level_host }}">Host</option>
                                    </select>
                                </div>
                            </div>
