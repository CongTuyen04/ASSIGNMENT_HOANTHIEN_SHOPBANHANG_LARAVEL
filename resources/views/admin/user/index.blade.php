                            ...
                            <tbody>
                                ...
                                @foreach ($users as $user)
                                    <tr>
                                                    ...
                                                    <div class="widget-content-left mr-3">
                                                        <div class="widget-content-left">
                                                            <img width="40px" class="rounded-circle"
                                                                ...
                                                                src="{{ asset('front/img/user/' . ($user->avatar ?? 'default-avatar.jpg')) }}" alt="">
                                                        </div>
                                                    </div>
                                        ...
                                        {{-- <td class="text-center">{{ \App\Utilities\Constant::$user_level[$user->level] ?? 'Unknown' }}</td> --}}
                                        <td class="text-center">
                                            {{ \App\Utilities\Constant::getUserLevels()[$user->level] ?? 'Unknown' }}
                                        </td>
                                        <td class="text-center">
